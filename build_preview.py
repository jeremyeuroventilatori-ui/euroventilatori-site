...
PAGES = [
    ...
    ("ventilateurs-centrifuges", "Ventilateurs centrifuges"),
    ("ventilateurs-helicoides", "Ventilateurs hélicoïdes"),
    ("traitement-surface", "Traitement de surface"),
    ...
    ("ile-de-france-rhone-alpes", "Rhône-Alpes"),
    ("paris", "Paris et Île-de-France"),
    ("lille", "Lille et Hauts-de-France"),
    ("bretagne", "Bretagne"),
